...
class CreateGeneralSettings extends SettingsMigration
{
    public function up(): void {
        ...
        $this->migrator->add('general.logo', 'https://i.ibb.co/T4dz7Gc/zetech.png');
        $this->migrator->add('general.footerLogo', 'https://i.ibb.co/T4dz7Gc/zetech.png');
        $this->migrator->add('general.favicon', 'https://i.ibb.co/cQfHWm5/favicon.png');
