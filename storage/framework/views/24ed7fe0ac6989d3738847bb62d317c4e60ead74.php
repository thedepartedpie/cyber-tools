...
} elseif ($_instance->childHasBeenRendered('gcILpfH')) {
    $componentId = $_instance->getRenderedChildComponentId('gcILpfH');
    $componentTag = $_instance->getRenderedChildComponentTagName('gcILpfH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gcILpfH');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('gcILpfH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/musab/Documents/cyber-tools/full/vendor/filament/filament/src/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>